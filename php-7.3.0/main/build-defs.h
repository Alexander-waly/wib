...
#define CONFIGURE_COMMAND " './configure'  '--disable-all' '--disable-cgi' '--disable-cli' '--disable-rpath' '--disable-phpdbg' '--with-valgrind=no' '--without-pear' '--without-pcre-jit' '--with-layout=GNU' '--enable-embed=static' '--enable-bcmath' '--enable-json' '--enable-ctype' '--enable-mbstring' '--disable-mbregex' '--enable-tokenizer' 'CFLAGS='"
...
#define PHP_EXTENSION_DIR       "/usr/local/lib/php/20180731"
